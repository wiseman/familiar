...
def number_frame_to_value(kb, frame):
  ...
  if kb.slot_value(frame, "value") != None:
    value = kb.slot_value(frame, "value")
    ...
    value = kb.slot_value(digit, "value")
  return numberify(value.op)
...
def populate_states(machine):
  ...
  global CHECK_IN, NINE_LINE, TALK_ON, RUN_IN, RADIO_CHECK
